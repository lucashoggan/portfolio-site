    ...
    <section id="contact">
      <div className="container">
        <div className="contact-inner">
          ...
          <a
            href="mailto:lucashoggan@yahoo.com"
            className="contact-email reveal"
          >
            lucashoggan@yahoo.com
          </a>
          <div className="social-row reveal">
            {/* GitHub */}
            <a
              href="https://github.com/lucashoggan"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/lucashoggan"
              className="social-link"
              target="_blank"
            >
              <svg
